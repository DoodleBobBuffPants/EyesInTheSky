...
% Function: create utilities for reading video and so on
...
% Function: sets default parameters
...
% Function: reads next frame
function frame = readFrame()
  frame = step(utilities.videoReader);
end

% Function: detect and annotate ball in video
...
% Function: detect ball in current frame
...
% Function: show current detection and tracking results
...
% Function: set initial location used by Kalman filter
